...
export default function StripePaymentMethodModal({ 
  ...
  const { createPaymentMethod, isLoading } = useStripe();
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const cardDetails = {
        ...
        cvc: cvv,
        address_zip: zipCode,
        brand: cardType === "amex" ? "amex" : "visa", // Simplified for demo
        last4: cardNumber.replace(/\s/g, "").slice(-4),
        expirationDate // Add this for compatibility with our existing code
      };
        ...
        >
          <View style={[
            ...
            <View style={styles.header}>
              <Text style={[typography.heading3, styles.title]}>Add Payment Method</Text>
              <TouchableOpacity 
              ...
              >
                <X size={24} color={isProcessing ? colors.primary.muted : colors.primary.text} />
              </TouchableOpacity>
            </View>
            ...
            >
              <View style={styles.formContainer}>
                ...
                <Text style={styles.testCardNote}>
                  For testing, use card number 4242 4242 4242 4242 with any future expiration date, any 3-digit CVV, and any 5-digit zip code.
                </Text>
              </View>
            </ScrollView>
            ...
            <View style={styles.footer}>
              <Button
                title={isProcessing ? "Processing..." : "Save Payment Method"}
                onPress={handleSave}
                variant="primary"
                disabled={isProcessing}
                icon={isProcessing ? <ActivityIndicator size="small" color="#FFFFFF" /> : undefined}
              />
            </View>
          </View>
        </KeyboardAvoidingView>
